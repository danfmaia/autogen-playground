...
values = range(20)  # Assuming these are prices, we'll convert them to percentages for demonstration

# Convert values to percentages (for example purposes, calculate % change from the first value)
